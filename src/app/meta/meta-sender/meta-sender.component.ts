...
export class MetaSenderComponent implements OnInit {
  ...
  async sendCoin() {
    ...
    try {
      ...
      let transaction;
      if (unlocked) {
        transaction = await deployedMetaCoin.sendCoin.sendTransaction(receiver, amount, {from: this.model.account});
      }
  ...
  async refreshBalance() {
    ...
    try {
      ...
      //await window.web3.eth.getBalance(this.model.account);
